...
namespace mud
{
    template <> TOY_CORE_EXPORT Type& type<toy::Behavior::Priority>();
    
#ifdef TOY_CORE_REFLECTION_IMPL
    void core_meta(Module& module)
    {   
    // Base Types
    ...
    // toy::Active
    {
        ...
        static Class cls = { type<toy::Active>(),
            ...
            // members
            {
                { type<toy::Active>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Actor
    {
        ...
        static Class cls = { type<toy::Actor>(),
            ...
            // members
            {
                { type<toy::Actor>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Behavior
    {
        ...
        static Class cls = { type<toy::Behavior>(),
            ...
            // members
            {
                { type<toy::Behavior>(), Address(), type<mud::Type>(), "type", Ref(type<mud::Type>()), Member::None }
            },
            // methods
            {
    ...
    // toy::BufferPage
    {
        ...
        static Class cls = { type<toy::BufferPage>(),
            ...
            // constructors
            {
                { type<toy::BufferPage>(), [](Ref ref, array<Var> args) { new(&val<toy::BufferPage>(ref)) toy::BufferPage( val<toy::Entity>(args[0]), val<toy::WorldPage>(args[1]), val<bool>(args[2]) ); }, { { "entity", Ref(type<toy::Entity>()) }, { "worldPage", Ref(type<toy::WorldPage>()) }, { "loaded", var(bool(false)), Param::Default } } }
            },
            // copy constructor
            {
            },
            // members
            {
                { type<toy::BufferPage>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
                { type<toy::BufferPage>(), Address(), type<toy::WorldPage>(), "worldPage", Ref(type<toy::WorldPage>()), Member::None },
    ...
    // toy::Camera
    {
        ...
        static Class cls = { type<toy::Camera>(),
            ...
            // constructors
            {
                { type<toy::Camera>(), [](Ref ref, array<Var> args) { new(&val<toy::Camera>(ref)) toy::Camera( val<toy::Entity>(args[0]), val<float>(args[1]), val<float>(args[2]), val<float>(args[3]) ); }, { { "entity", Ref(type<toy::Entity>()) }, { "lensDistance", var(float(1.f)), Param::Default }, { "nearClipDistance", var(float(0.001f)), Param::Default }, { "farClipDistance", var(float(1000.f)), Param::Default } } }
            },
            // copy constructor
            {
            },
            // members
            {
                { type<toy::Camera>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
    ...
    // toy::Emitter
    {
        ...
        static Class cls = { type<toy::Emitter>(),
            ...
            // members
            {
                { type<toy::Emitter>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::EventRelay
    {
        ...
        static Class cls = { type<toy::EventRelay>(),
            ...
            // members
            {
                { type<toy::EventRelay>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::LightReflector
    {
        ...
        static Class cls = { type<toy::LightReflector>(),
            ...
            // members
            {
                { type<toy::LightReflector>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
    ...
    // toy::LightSource
    {
        ...
        static Class cls = { type<toy::LightSource>(),
            ...
            // members
            {
                { type<toy::LightSource>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
                { type<toy::LightSource>(), Address(), type<toy::Emitter>(), "emitter", Ref(type<toy::Emitter>()), Member::None },
    ...
    // toy::Manoeuvrable
    {
        static Meta meta = { type<toy::Manoeuvrable>(), &namspc({ "toy" }), "Manoeuvrable", sizeof(toy::Manoeuvrable), TypeClass::Object };
        static Class cls = { type<toy::Manoeuvrable>(),
            // bases
            {  },
            {  },
            // constructors
            {
                { type<toy::Manoeuvrable>(), [](Ref ref, array<Var> args) { new(&val<toy::Manoeuvrable>(ref)) toy::Manoeuvrable( val<toy::Entity>(args[0]), val<float>(args[1]), val<float>(args[2]) ); }, { { "entity", Ref(type<toy::Entity>()) }, { "radius", var(float()) }, { "height", var(float()) } } }
            },
            // copy constructor
            {
            },
            // members
            {
                { type<toy::Manoeuvrable>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
                { type<toy::Manoeuvrable>(), member_address(&toy::Manoeuvrable::m_radius), type<float>(), "radius", var(float()), Member::Flags(Member::Value|Member::Mutable) },
                { type<toy::Manoeuvrable>(), member_address(&toy::Manoeuvrable::m_height), type<float>(), "height", var(float()), Member::Flags(Member::Value|Member::Mutable) }
            },
            // methods
            {
            },
        ...
        init_pool<toy::Manoeuvrable>(); 
        
        meta_class<toy::Manoeuvrable>();
    }
    ...
    // toy::Movable
    {
        ...
        static Class cls = { type<toy::Movable>(),
            ...
            // members
            {
                { type<toy::Movable>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Navblock
    {
        ...
        static Class cls = { type<toy::Navblock>(),
            ...
            // constructors
            {
                { type<toy::Navblock>(), [](Ref ref, array<Var> args) { new(&val<toy::Navblock>(ref)) toy::Navblock( val<toy::Navmesh>(args[0]), val<toy::Entity>(args[1]), val<toy::WorldPage>(args[2]) ); }, { { "navmesh", Ref(type<toy::Navmesh>()) }, { "entity", Ref(type<toy::Entity>()) }, { "worldPage", Ref(type<toy::WorldPage>()) } } }
            },
            // copy constructor
            {
            },
            // members
            {
                { type<toy::Navblock>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
                { type<toy::Navblock>(), Address(), type<toy::WorldPage>(), "worldPage", Ref(type<toy::WorldPage>()), Member::None },
                { type<toy::Navblock>(), Address(), type<toy::Navmesh>(), "navmesh", Ref(type<toy::Navmesh>()), Member::None },
    ...
    // toy::Navmesh
    {
        ...
        static Class cls = { type<toy::Navmesh>(),
            ...
            // members
            {
                { type<toy::Navmesh>(), Address(), type<toy::World>(), "world", Ref(type<toy::World>()), Member::None },
    ...
    // toy::Obstacle
    {
        ...
        static Class cls = { type<toy::Obstacle>(),
            ...
            // members
            {
                { type<toy::Obstacle>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
    ...
    // toy::PhysicWorld
    {
        ...
        static Class cls = { type<toy::PhysicWorld>(),
            ...
            // members
            {
                { type<toy::PhysicWorld>(), Address(), type<toy::World>(), "world", Ref(type<toy::World>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Player
    {
        static Meta meta = { type<toy::Player>(), &namspc({ "toy" }), "Player", sizeof(toy::Player), TypeClass::Object };
        static Class cls = { type<toy::Player>(),
            // bases
            {  },
            {  },
            // constructors
            {
                { type<toy::Player>(), [](Ref ref, array<Var> args) { new(&val<toy::Player>(ref)) toy::Player( val<mud::Id>(args[0]), val<std::string>(args[1]) ); }, { { "id", var(mud::Id()) }, { "name", var(std::string()) } } }
            },
            // copy constructor
            {
            },
            // members
            {
                { type<toy::Player>(), member_address(&toy::Player::m_id), type<mud::Id>(), "id", var(mud::Id()), Member::Flags(Member::Value|Member::Mutable) },
                { type<toy::Player>(), member_address(&toy::Player::m_name), type<std::string>(), "name", var(std::string()), Member::Flags(Member::Value|Member::Mutable) },
                { type<toy::Player>(), member_address(&toy::Player::m_selection), type<std::vector<mud::Ref>>(), "selection", var(std::vector<mud::Ref>()), Member::Flags(Member::Value|Member::Mutable) }
            },
            // methods
            {
            },
        ...
        init_pool<toy::Player>(); 
        
        meta_class<toy::Player>();
    }
    ...
    // toy::Reactive
    {
        ...
        static Class cls = { type<toy::Reactive>(),
            ...
            // members
            {
                { type<toy::Reactive>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
    ...
    // toy::Receptor
    {
        ...
        static Class cls = { type<toy::Receptor>(),
            ...
            // members
            {
                { type<toy::Receptor>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Selector
    {
        ...
        static Class cls = { type<toy::Selector>(),
            ...
            // members
            {
                { type<toy::Selector>(), Address(), type<toy::User>(), "user", Ref(type<toy::User>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Symbolic
    {
        ...
        static Class cls = { type<toy::Symbolic>(),
            ...
            // members
            {
                { type<toy::Symbolic>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
    ...
    // toy::View
    {
        ...
        static Class cls = { type<toy::View>(),
            ...
            // members
            {
                { type<toy::View>(), Address(), type<mud::Type>(), "type", Ref(type<mud::Type>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Vision
    {
        ...
        static Class cls = { type<toy::Vision>(),
            ...
            // members
            {
                { type<toy::Vision>(), Address(), type<toy::World>(), "world", Ref(type<toy::World>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::Entity
    {
        static Meta meta = { type<toy::Entity>(), &namspc({ "toy" }), "Entity", sizeof(toy::Entity), TypeClass::Complex };
        static Class cls = { type<toy::Entity>(),
            // bases
            { &type<mud::Complex>() },
            { base_offset<toy::Entity, mud::Complex>() },
            // constructors
            {
                { type<toy::Entity>(), [](Ref ref, array<Var> args) { new(&val<toy::Entity>(ref)) toy::Entity( val<mud::Id>(args[0]), val<mud::Prototype>(args[1]), val<toy::Entity>(args[2]), val<mud::vec3>(args[3]), val<mud::quat>(args[4]) ); }, { { "id", var(mud::Id()) }, { "prototype", Ref(type<mud::Prototype>()) }, { "parent", Ref(type<toy::Entity>()) }, { "position", var(mud::vec3()) }, { "rotation", var(mud::quat()) } } },
                { type<toy::Entity>(), [](Ref ref, array<Var> args) { new(&val<toy::Entity>(ref)) toy::Entity( val<mud::Id>(args[0]), val<mud::Prototype>(args[1]), val<toy::World>(args[2]), &val<toy::Entity>(args[3]), val<mud::vec3>(args[4]), val<mud::quat>(args[5]) ); }, { { "id", var(mud::Id()) }, { "prototype", Ref(type<mud::Prototype>()) }, { "world", Ref(type<toy::World>()) }, { "parent", Ref(type<toy::Entity>()), Param::Nullable }, { "position", var(mud::vec3()) }, { "rotation", var(mud::quat()) } } }
            },
            // copy constructor
            {
            },
            // members
            {
                { type<toy::Entity>(), Address(), type<toy::World>(), "world", Ref(type<toy::World>()), Member::None },
    ...
    // toy::World
    {
        static Meta meta = { type<toy::World>(), &namspc({ "toy" }), "World", sizeof(toy::World), TypeClass::Complex };
        static Class cls = { type<toy::World>(),
            // bases
            { &type<mud::Complex>() },
            { base_offset<toy::World, mud::Complex>() },
            // constructors
            {
                { type<toy::World>(), [](Ref ref, array<Var> args) { new(&val<toy::World>(ref)) toy::World( val<mud::Id>(args[0]), val<mud::Prototype>(args[1]), val<std::string>(args[2]) ); }, { { "id", var(mud::Id()) }, { "prototype", Ref(type<mud::Prototype>()) }, { "name", var(std::string()) } } }
            },
            // copy constructor
            {
            },
            // members
            {
                ...
                { type<toy::World>(), member_address(&toy::World::origin), type<toy::Entity>(), "origin", Ref(type<toy::Entity>()), Member::Structure },
                { type<toy::World>(), member_address(&toy::World::unworld), type<toy::Entity>(), "unworld", Ref(type<toy::Entity>()), Member::Structure }
            },
            // methods
            {
            },
    ...
    // toy::Area
    {
        ...
        static Class cls = { type<toy::Area>(),
            ...
            // members
            {
                { type<toy::Area>(), member_address(&toy::Area::entity), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
                { type<toy::Area>(), member_address(&toy::Area::shape), type<toy::CollisionShape>(), "shape", Ref(type<toy::CollisionShape>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::WorldPage
    {
        ...
        static Class cls = { type<toy::WorldPage>(),
            ...
            // members
            {
                { type<toy::WorldPage>(), Address(), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None },
                { type<toy::WorldPage>(), Address(), type<toy::Emitter>(), "emitter", Ref(type<toy::Emitter>()), Member::None },
                ...
                { type<toy::WorldPage>(), Address(), type<toy::World>(), "world", Ref(type<toy::World>()), Member::None },
            ...
            // methods
            {
                { type<toy::WorldPage>(), "buildGeometry", member_address(&toy::WorldPage::buildGeometry), [](Ref object, array<Var> args, Var& result) { UNUSED(result); UNUSED(args);val<toy::WorldPage>(object).buildGeometry(); }, {}, Var() },
                { type<toy::WorldPage>(), "updateGeometry", member_address(&toy::WorldPage::updateGeometry), [](Ref object, array<Var> args, Var& result) { UNUSED(result); UNUSED(args);val<toy::WorldPage>(object).updateGeometry(); }, {}, Var() },
                { type<toy::WorldPage>(), "groundPoint", member_address(&toy::WorldPage::groundPoint), [](Ref object, array<Var> args, Var& result) { UNUSED(result); val<toy::WorldPage>(object).groundPoint(val<mud::vec3>(args[0]), val<bool>(args[1]), val<mud::vec3>(args[2])); }, { { "position", var(mud::vec3()) }, { "relative", var(bool()) }, { "outputPoint", var(mud::vec3()), Param::Output } }, Var() },
                { type<toy::WorldPage>(), "raycastGround", member_address(&toy::WorldPage::raycastGround), [](Ref object, array<Var> args, Var& result) { UNUSED(result); val<toy::WorldPage>(object).raycastGround(val<mud::vec3>(args[0]), val<mud::vec3>(args[1]), val<mud::vec3>(args[2])); }, { { "from", var(mud::vec3()) }, { "to", var(mud::vec3()) }, { "groundPoint", var(mud::vec3()) } }, Var() }
            },
            // static members
            {
            }
    ...
    // toy::ObstacleBody
    {
        ...
        static Class cls = { type<toy::ObstacleBody>(),
            ...
            // members
            {
                { type<toy::ObstacleBody>(), member_address(&toy::ObstacleBody::collisionShape), type<toy::CollisionShape>(), "collisionShape", Ref(type<toy::CollisionShape>()), Member::None },
    ...
    // toy::PlayerVision
    {
        static Meta meta = { type<toy::PlayerVision>(), &namspc({ "toy" }), "PlayerVision", sizeof(toy::PlayerVision), TypeClass::Object };
        static Class cls = { type<toy::PlayerVision>(),
            // bases
            { &type<toy::Vision>() },
            { base_offset<toy::PlayerVision, toy::Vision>() },
            // constructors
            {
            },
            // copy constructor
    ...
    // toy::Origin
    {
        ...
        static Class cls = { type<toy::Origin>(),
            // bases
            { &type<mud::Construct>() },
            { base_offset<toy::Origin, mud::Construct>() },
            // constructors
            {
            ...
            // members
            {
                { type<toy::Origin>(), member_address(&toy::Origin::m_entity), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::DefaultWorld
    {
        ...
        static Class cls = { type<toy::DefaultWorld>(),
            // bases
            { &type<mud::Construct>() },
            { base_offset<toy::DefaultWorld, mud::Construct>() },
            // constructors
            {
            ...
            // members
            {
                { type<toy::DefaultWorld>(), member_address(&toy::DefaultWorld::m_world), type<toy::World>(), "world", Ref(type<toy::World>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::OCamera
    {
        static Meta meta = { type<toy::OCamera>(), &namspc({ "toy" }), "OCamera", sizeof(toy::OCamera), TypeClass::Object };
        static Class cls = { type<toy::OCamera>(),
            // bases
            { &type<mud::Construct>() },
            { base_offset<toy::OCamera, mud::Construct>() },
            // constructors
            {
            ...
            // members
            {
                { type<toy::OCamera>(), member_address(&toy::OCamera::m_entity), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::OLight
    {
        static Meta meta = { type<toy::OLight>(), &namspc({ "toy" }), "OLight", sizeof(toy::OLight), TypeClass::Object };
        static Class cls = { type<toy::OLight>(),
            // bases
            { &type<mud::Construct>() },
            { base_offset<toy::OLight, mud::Construct>() },
            // constructors
            {
            ...
            // members
            {
                { type<toy::OLight>(), member_address(&toy::OLight::m_entity), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
    ...
    // toy::OWaypoint
    {
        static Meta meta = { type<toy::OWaypoint>(), &namspc({ "toy" }), "OWaypoint", sizeof(toy::OWaypoint), TypeClass::Object };
        static Class cls = { type<toy::OWaypoint>(),
            // bases
            { &type<mud::Construct>() },
            { base_offset<toy::OWaypoint, mud::Construct>() },
            // constructors
            {
            ...
            // members
            {
                { type<toy::OWaypoint>(), member_address(&toy::OWaypoint::m_entity), type<toy::Entity>(), "entity", Ref(type<toy::Entity>()), Member::None }
            },
            // methods
            {
            },
        ...
        module.m_types.push_back(&type<toy::Active>());
        module.m_types.push_back(&type<toy::Actor>());
        module.m_types.push_back(&type<toy::Array<toy::Action>>());
        module.m_types.push_back(&type<toy::Array<toy::Entity>>());
        module.m_types.push_back(&type<toy::Behavior>());
        module.m_types.push_back(&type<toy::BufferPage>());
        module.m_types.push_back(&type<toy::BulletShape>());
        module.m_types.push_back(&type<toy::Camera>());
        module.m_types.push_back(&type<toy::Collider>());
        module.m_types.push_back(&type<toy::ColliderImpl>());
        module.m_types.push_back(&type<toy::ColliderObject>());
        module.m_types.push_back(&type<toy::CollisionShape>());
        module.m_types.push_back(&type<toy::Core>());
        module.m_types.push_back(&type<toy::DetourPath>());
        module.m_types.push_back(&type<toy::Effect>());
        module.m_types.push_back(&type<toy::Emitter>());
        module.m_types.push_back(&type<toy::EventFilter>());
        module.m_types.push_back(&type<toy::EventRelay>());
        module.m_types.push_back(&type<toy::GroundMotion>());
        module.m_types.push_back(&type<toy::LightReflector>());
        module.m_types.push_back(&type<toy::LightSource>());
        module.m_types.push_back(&type<toy::Manoeuvrable>());
        module.m_types.push_back(&type<toy::Movable>());
        module.m_types.push_back(&type<toy::Navblock>());
        module.m_types.push_back(&type<toy::Navmesh>());
        module.m_types.push_back(&type<toy::Obstacle>());
        module.m_types.push_back(&type<toy::Pathfinder>());
        module.m_types.push_back(&type<toy::PhysicWorld>());
        module.m_types.push_back(&type<toy::Player>());
        module.m_types.push_back(&type<toy::Reactive>());
        module.m_types.push_back(&type<toy::Receptor>());
        module.m_types.push_back(&type<toy::Selector>());
        module.m_types.push_back(&type<toy::SoundMedium>());
        module.m_types.push_back(&type<toy::State>());
        module.m_types.push_back(&type<toy::SubBulletWorld>());
        module.m_types.push_back(&type<toy::Symbolic>());
        module.m_types.push_back(&type<toy::TaskSection>());
        module.m_types.push_back(&type<toy::User>());
        module.m_types.push_back(&type<toy::View>());
        module.m_types.push_back(&type<toy::Vision>());
        module.m_types.push_back(&type<toy::VisualMedium>());
        module.m_types.push_back(&type<toy::WorldClock>());
        module.m_types.push_back(&type<toy::WorldMedium>());
        module.m_types.push_back(&type<std::vector<mud::Symbol>>());
        module.m_types.push_back(&type<toy::Entity>());
        module.m_types.push_back(&type<toy::World>());
        module.m_types.push_back(&type<toy::NavmeshShape>());
        module.m_types.push_back(&type<toy::Action>());
        module.m_types.push_back(&type<toy::BulletWorld>());
        module.m_types.push_back(&type<toy::QueueSection>());
        module.m_types.push_back(&type<toy::MonoSection>());
        module.m_types.push_back(&type<toy::ParallelSection>());
        module.m_types.push_back(&type<toy::BulletCollider>());
        module.m_types.push_back(&type<toy::Area>());
        module.m_types.push_back(&type<toy::WorldPage>());
        module.m_types.push_back(&type<toy::Solid>());
        module.m_types.push_back(&type<toy::PhysicScope>());
        module.m_types.push_back(&type<toy::ObstacleBody>());
        module.m_types.push_back(&type<toy::BulletSolid>());
        module.m_types.push_back(&type<toy::EmitterSphere>());
        module.m_types.push_back(&type<toy::ReceptorSphere>());
        module.m_types.push_back(&type<toy::EventEmitter>());
        module.m_types.push_back(&type<toy::EmitterScope>());
        module.m_types.push_back(&type<toy::ReceptorScope>());
        module.m_types.push_back(&type<toy::EventReceptor>());
        module.m_types.push_back(&type<toy::StoreView>());
        module.m_types.push_back(&type<toy::ReceptorView>());
        module.m_types.push_back(&type<toy::PlayerVision>());
        module.m_types.push_back(&type<toy::OmniVision>());
        module.m_types.push_back(&type<toy::Origin>());
        module.m_types.push_back(&type<toy::DefaultWorld>());
        module.m_types.push_back(&type<toy::OCamera>());
        module.m_types.push_back(&type<toy::OLight>());
        module.m_types.push_back(&type<toy::OWaypoint>());
